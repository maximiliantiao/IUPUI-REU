...
# coding: utf-8
"""
Source: https://towardsdatascience.com/preserving-data-privacy-in-deep-learning-part-1-a04894f78029
"""
...
############### optimizers ################
opt = [optim.SGD(model.parameters(), lr=0.1, momentum=0.9) for model in client_models]
...
print("Best testing accuracy: " + str(max(acc_test)))
